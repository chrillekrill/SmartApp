...
namespace AzureFunctions
{
    public static class Connect
    {
        ...
        private static readonly RegistryManager _registryManager = RegistryManager.CreateFromConnectionString(iothub_connectionstring);
            ...
            ILogger log)
        {
            try
            {
                ...
                var connectionstring = $"HostName={iothub_connectionstring.Split(";")[0].Split("=")[1]};DeviceId={device.Id};SharedAccessKey={device.Authentication.SymmetricKey.PrimaryKey}";
